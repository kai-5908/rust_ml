...
impl TrainService{
    ...
    pub fn fit(&self) -> RandomForestClassifier<f64>{
        ...
        let classifier = RandomForestClassifier::fit(&self.train_x, &self.train_y, parameters).unwrap();
        classifier
    }
    ...
    pub fn validate(&self, classifier: RandomForestClassifier<f64>) {
        ...
        println!("accuracy: {}, recall: {}, precision: {}, f1: {}, roc_auc: {}", accuracy, recall, precision, f1, roc_auc);
